...
export const INITIAL_TEACHERS: Teacher[] = [
  { id: 't1', name: 'Smt. Lakshmi', role: 'Teacher', phone: '9988776655', qualification: 'M.A, B.Ed', subjectSpecialization: 'Language', isClassTeacher: true, assignedClass: '10-A', monthlySalary: 30000 },
  ...
  { id: 't3', name: 'Mrs. Sarah', role: 'Teacher', phone: '9988776633', qualification: 'B.Sc, B.Ed', subjectSpecialization: 'Science', isClassTeacher: true, assignedClass: '9-A', monthlySalary: 28000 },
...
export const generateDefaultFeeStructure = (): FeeStructure[] => {
  ...
  mediums.forEach(medium => {
    standards.forEach(std => {
      ...
      const stdIndex = standards.indexOf(std);
...
const generateMockData = () => {
  ...
  for (let i = 0; i < 2000; i++) {
    ...
    // Distribute randomly
    const standardIndex = Math.floor(Math.pow(Math.random(), 1.5) * standards.length);
