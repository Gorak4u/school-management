...
export const Fees: React.FC<FeesProps> = ({ fees, students, busRoutes, onUpdateFee, settings, onShowHistory }) => {
  ...
  // Helper to determine available standards based on selected medium filter
  const availableStandards = useMemo(() => {
    if (filterMedium !== 'All' && settings.mediumSpecificStandards && settings.mediumSpecificStandards[filterMedium]) {
        return settings.mediumSpecificStandards[filterMedium];
    }
    return settings.standards;
  }, [filterMedium, settings]);
