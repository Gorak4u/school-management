...
export const TimetableComponent: React.FC<TimetableProps> = ({ timetables, teachers, onSaveTimetable, settings }) => {
  ...
  // Available classes based on medium
  const availableStandards = useMemo(() => {
    if (settings.mediumSpecificStandards && settings.mediumSpecificStandards[medium]) {
        return settings.mediumSpecificStandards[medium];
    }
